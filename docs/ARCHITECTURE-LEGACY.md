> Historical architecture document retained for research. It may describe incomplete modules or outdated assumptions. See the primary architecture document first.
